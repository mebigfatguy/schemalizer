...
public class Schemalizer implements SchemalizerConstants {
     ...
     * 
     * @param xmlStream
     *            the xml file presented as a stream
     * 
     * @throws SchemalizerException
     */
    public void addSample(InputStream xmlStream) throws SchemalizerException {
        try {
     ...
     * 
     * @param xmlDocument
     *            the xml file presented as a DOM Document
     * 
     * @throws SchemalizerException
     */
    public void addSample(Document xmlDocument) throws SchemalizerException {
     ...
     * @throws SchemalizerException
     */
    public Document build() throws SchemalizerException {
        try {
     ...
     * 
     * @param xsdStream
     *            the stream to write the schema data to
     * @throws SchemalizerException
     */
    public void build(OutputStream xsdStream) throws SchemalizerException {
        try {
            Document d = build();
            emitXML(d, xsdStream);
        } catch (Exception e) {
     ...
     * 
     * @throws SchemalizerException
     *             if the document type doesn't match
     */
    private void validateDocumentType(Document d) throws SchemalizerException {
     ...
     */
    private void emitXML(Document xsd, OutputStream xsdStream) throws TransformerException {
